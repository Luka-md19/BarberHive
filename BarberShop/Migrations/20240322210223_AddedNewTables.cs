    ...
    public partial class AddedNewTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactFormSections", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ButtonText = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SiteLinks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PolicyDocuments = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactFormSectionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FormFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FormFields_ContactFormSections_ContactFormSectionId",
                        column: x => x.ContactFormSectionId,
                        principalTable: "ContactFormSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NavbarActions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NavbarActions_Navbars_NavbarId",
                        column: x => x.NavbarId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StatsSectionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatItems_StatsSections_StatsSectionId",
                        column: x => x.StatsSectionId,
                        principalTable: "StatsSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CalendlyLink = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ...
                    TeamSectionId = table.Column<int>(type: "int", nullable: false),
                    TeamSectionId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Barbers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Barbers_TeamSections_TeamSectionId",
                        column: x => x.TeamSectionId,
                        principalTable: "TeamSections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Barbers_TeamSections_TeamSectionId1",
                        column: x => x.TeamSectionId1,
                        principalTable: "TeamSections",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CalendlyEventId = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "03683319-0554-4d85-8f28-cc3876fcb625", null, "User", "USER" },
                    { "89ff8dc5-47c5-498b-9377-aca1d38b3c4f", null, "Administrator", "ADMINISTRATOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Barbers_TeamSectionId",
                table: "Barbers",
                column: "TeamSectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormFields_ContactFormSectionId",
                table: "FormFields",
                column: "ContactFormSectionId");

            migrationBuilder.CreateIndex(
                name: "IX_NavbarActions_NavbarId",
                table: "NavbarActions",
                column: "NavbarId");

            migrationBuilder.CreateIndex(
                name: "IX_StatItems_StatsSectionId",
                table: "StatItems",
                column: "StatsSectionId");
